  ...
  return (
    <section className="py-6 sm:py-8 md:py-10 lg:py-12 overflow-hidden bg-linear-to-b from-cream to-white">
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 max-w-[1400px]">
        ...
        >
          <motion.span
            className="inline-block px-3 py-1.5 sm:px-4 sm:py-2 md:px-5 md:py-2 bg-cream border border-secondary/30 rounded-full text-primary text-xs sm:text-sm font-semibold mb-2 sm:mb-3 md:mb-4"
            whileHover={{ scale: 1.05 }}
            transition={{ duration: 0.2 }}
          >
            Leadership
          </motion.span>
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl font-bold text-navy mb-2 sm:mb-3 px-4 leading-tight">
            Message from the Provincial
          </h2>
          <motion.div
            className="w-12 sm:w-14 md:w-16 lg:w-20 h-0.5 sm:h-1 bg-secondary mx-auto rounded-full"
            initial={{ width: 0 }}
        ...
        >
          <div className="bg-white rounded-lg sm:rounded-xl md:rounded-2xl shadow-lg md:shadow-xl overflow-hidden">
            <div className="flex flex-col lg:flex-row items-stretch">
              ...
              >
                <div className="relative h-64 sm:h-80 md:h-96 lg:h-full lg:min-h-[480px] overflow-hidden group">
                  <img
                    src={imageSrc}
                  ...
                  {/* Quote Icon */}
                  <motion.div
                    className="absolute top-3 right-3 sm:top-4 sm:right-4 bg-white/95 backdrop-blur-sm p-2 sm:p-2.5 md:p-3 rounded-full shadow-lg"
                    whileHover={{ rotate: 180, scale: 1.1 }}
                    transition={{ duration: 0.4 }}
                  >
                    <BsQuote className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary" />
                  </motion.div>
                </div>
              </motion.div>
              ...
              {/* Content Section */}
              <motion.div
                className="w-full lg:w-[60%] p-5 sm:p-6 md:p-7 lg:p-8 flex flex-col justify-center"
                variants={contentVariants}
              >
                {/* Name and Title */}
                <motion.div className="mb-3 sm:mb-4" variants={itemVariants}>
                  <h3 className="text-lg sm:text-xl md:text-2xl lg:text-2xl font-bold text-primary mb-1 sm:mb-1.5 leading-tight">
                    {provincialData.title}
                  </h3>
                  <p className="text-sm sm:text-base md:text-base text-secondary font-semibold leading-snug">
                ...
                {/* Divider */}
                <motion.div
                  className="w-12 sm:w-14 md:w-16 h-0.5 bg-secondary/60 rounded-full mb-3 sm:mb-4"
                  initial={{ width: 0 }}
                ...
                >
                  <div className="relative pl-3 sm:pl-4 border-l-2 border-secondary/40">
                    <p className="text-xs sm:text-sm md:text-base text-navy leading-relaxed">
                      {previewDescription}
                ...
                >
                  ...
                  >
                    <motion.button
                      className="w-full flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2.5 sm:py-2 md:py-3 bg-white border-2 border-primary text-primary rounded-md sm:rounded-lg font-medium text-xs sm:text-sm hover:bg-primary hover:text-white transition-all duration-300 cursor-pointer"
                      whileHover={{ scale: 1.03, y: -2 }}
                      whileTap={{ scale: 0.98 }}
                    >
                      <span className="truncate">Read More</span>
                      <HiArrowRight className="w-3.5 h-3.5 sm:w-4 sm:h-4 shrink-0" />
                    </motion.button>
                  </Link>
                  <motion.button
                    className="w-full flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2.5 sm:py-2 md:py-3 bg-primary text-white rounded-md sm:rounded-lg font-medium text-xs sm:text-sm shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer"
                    whileHover={{ scale: 1.03, y: -2 }}
                    whileTap={{ scale: 0.98 }}
                  >
                    <HiCalendar className="w-3.5 h-3.5 sm:w-4 sm:h-4 shrink-0" />
        ...
        <motion.div
          className="mt-6 sm:mt-7 md:mt-8 lg:mt-10 max-w-4xl mx-auto"
          ...
          >
            <div className="flex items-start gap-2.5 sm:gap-3">
              <motion.div
                ...
                className="shrink-0"
              >
                <BsQuote className="w-5 h-5 sm:w-6 sm:h-6 text-secondary mt-0.5 sm:mt-1" />
              </motion.div>
              <div className="space-y-1.5 sm:space-y-2 flex-1 min-w-0">
                <p className="text-xs sm:text-sm md:text-base text-navy leading-relaxed italic">
