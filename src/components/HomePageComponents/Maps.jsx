...
const Maps = () => {
  ...
  return (
    <section className="py-4 sm:py-6 lg:py-8 bg-linear-to-b from-white to-primary">
      <div className="container mx-auto px-4 sm:px-8 lg:px-12">
        ...
        {/* Map Container - Wider on desktop, compact on mobile */}
        <motion.div
          className="max-w-6xl sm:max-w-7xl lg:max-w-[95%] xl:max-w-[90%] mx-auto"
          initial="hidden"
          whileInView="visible"
        ...
        >
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            {/* Responsive Map Wrapper - Mobile correct, Desktop wider & shorter */}
            <div className="relative w-full aspect-4/3 sm:aspect-[3/1] lg:aspect-[21/5] xl:aspect-[5/1]">
              <iframe 
            ...
            <div className="p-4 sm:p-5 bg-linear-to-r from-primary/5 to-secondary/5">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                ...
                <motion.a
                  ...
                  className="px-5 py-2.5 bg-primary hover:bg-primary/90 text-white text-sm font-semibold rounded-lg shadow-md hover:shadow-lg transition-all duration-300 flex items-center gap-2 whitespace-nowrap"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
