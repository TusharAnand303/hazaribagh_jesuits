...
import h5 from '../assets/images/web_images/h4.jpeg'
  ...
  return (
    <div className="min-h-screen bg-cream text-navy">
      ...
      <main className="container mx-auto px-6 py-12">
        ...
        <img src={h5} alt="" className='mb-10 rounded-md' />
            </motion.section>
            ...
            >
              <div className="flex items-center mb-6">
                <div className="w-2 h-12 bg-secondary rounded mr-4"></div>
                <h2 className="text-3xl font-bold text-navy">Tilling and Seeding</h2>
              </div>
            ...
            >
              <div className="flex items-center mb-6">
                <div className="w-2 h-12 bg-secondary rounded mr-4"></div>
                <h2 className="text-3xl font-bold text-navy">Sprouting and Rooting</h2>
              </div>
            ...
            >
              <div className="flex items-center mb-6">
                <div className="w-2 h-12 bg-secondary rounded mr-4"></div>
                <h2 className="text-3xl font-bold text-navy">Growth and Development</h2>
              </div>
            ...
            >
              <div className="flex items-center mb-6">
                <div className="w-2 h-12 bg-secondary rounded mr-4"></div>
                <h2 className="text-3xl font-bold text-navy">Collaborators</h2>
              </div>
            ...
            >
              <div className="flex items-center mb-6">
                <div className="w-2 h-12 bg-secondary rounded mr-4"></div>
                <h2 className="text-3xl font-bold text-navy">Today</h2>
              </div>
            ...
            >
              <div className="flex items-center mb-6">
                <div className="w-2 h-12 bg-secondary rounded mr-4"></div>
                <h2 className="text-3xl font-bold text-navy">Challenges of the Hazaribag Jesuits Today</h2>
              </div>
              ...
              <div className="bg-amber-50 border-l-4 border-secondary p-6 rounded-r-lg">
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start">
                    <span className="text-secondary font-bold mr-3">5.</span>
                    <span className="text-gray-700 leading-relaxed">
                  ...
                  <li className="flex items-start">
                    <span className="text-secondary font-bold mr-3">6.</span>
                    <span className="text-gray-700 leading-relaxed">
                      Accept the realities of life and go forward with hope in the Lord.
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-secondary font-bold mr-3">7.</span>
                    <span className="text-gray-700 leading-relaxed">
                      Creeping of individualism among Jesuits.
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-secondary font-bold mr-3">8.</span>
                    <span className="text-gray-700 leading-relaxed">
