    ...
    <div className="min-h-screen bg-gradient-to-t from-cream to-white text-navy py-20">
      ...
      <header className="container mx-auto px-6 mb-20 text-center">
        ...
        >
          ...
          <p className="text-xl sm:text-2xl text-navy/80 max-w-3xl mx-auto font-medium">
            A global network uniting millions in prayer and action with the Holy
            Father
          </p>
        </motion.div>
      </header>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 max-w-7xl mx-auto">
            {prayers.map((item, index) => (
              <motion.div
                ...
                onClick={() =>
                  navigate(`/popes-worldwide-prayer/${item.id}`)
                }
              >
                {/* Image */}
